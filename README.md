...
<br>
<img src="./source/채팅-외부 알람.png" width="100%" alt="전역 알림 시스템">

**2) 채팅방 목록 및 초대 관리 시스템**
- 사이드바를 통해 참여 중인 목록을 실시간으로 확인하며, **안읽은 메시지 수**와 **마지막 메시지**를 즉각 파악할 수 있습니다.
- 새로운 채팅 초대에 대한 **수락/거절** 기능, 특정 방을 상단에 고정하는 **하이라이트**, 그리고 **채팅방 초대 및 프로필 변경** 등 통합 관리 기능을 제공합니다.
<br>
<div align="center">
...
- 주변 이웃과의 **1:1 대화**는 물론, 특정 주제나 목적에 맞는 **그룹 채팅방**을 자유롭게 개설할 수 있습니다.
- 그룹 채팅방 개설 시 전용 **프로필 설정 기능**을 통해 커뮤니티의 성격을 명확히 정의할 수 있습니다.
<br>
<div align="center">
  <img src="./source/1대1 초대.png" width="49%" alt="1대1 채팅 초대">
  <img src="./source/그룹 초대.png" width="49%" alt="그룹 채팅 초대">
</div>

**4) 유저 온라인 상태 확인 및 즉각 소통**
...
- 전용 관리 패널을 통해 **채팅방 멤버의 권한(초대, 강퇴 등)을 세부적으로 설정**할 수 있습니다.
- 보안 및 운영 안정성을 위해 **방장이 아닌 일반 멤버는 권한 수정이나 채팅방 설정 변경이 불가능**하도록 설계되었습니다.
<br>
<div align="center">
  <img src="./source/채팅방관리1.png" width="49%" alt="방장 관리 도구">
  <img src="./source/채팅방관리-권한없음.png" width="49%" alt="일반 멤버 화면">
</div>
...
**7) 채팅 고급 기능 (공지, 공감, 답장, 시스템 메시지)**
- 특정 메시지에 대한 **공감(토글 형식) 및 답장** 기능을 지원하며, 해당 영역 클릭 시 **관련 메시지 위치로 즉시 이동**하는 스마트 네비게이션을 구현했습니다.
- 채팅방 생성, 유저 입장/퇴장 등 핵심 이벤트를 안내하는 **시스템 메시지**와 중요 정보를 고정하는 **공지사항** 기능을 통해 소통의 효율을 높였습니다.
<br>
<img src="./source/공지,마지막 읽음 이동, 날짜,공감,답장,초대 시스템 알람 등.png" width="100%" alt="채팅 고급 편의 기능">

**8) 미디어 공유 및 파일 업로드**
- 채팅 중 사진과 파일을 자유롭게 업로드하고 공유할 수 있으며, 전송된 이미지는 썸네일로 즉시 확인할 수 있습니다.
<br>
<img src="./source/사진썸네일이나 파일 업로드, 마지막읽음 표시.png" width="100%" alt="미디어 공유 기능">

**9) 강력한 메시지 검색 시스템**
- 수많은 대화 내역 속에서 필요한 정보를 키워드 기반으로 빠르게 찾아낼 수 있는 전문화된 메시지 검색 기능을 제공합니다.
<br>
<div align="center">
  <img src="./source/검색기능.png" width="49%" alt="메시지 검색 시스템">
</div>

**10) 맞춤형 날씨 정보 및 AI 환경 비서**
- 기상청 실시간 데이터와 Google Gemini AI를 연동하여, 현재 날씨와 맥락에 맞는 **친환경 실천 멘트**를 대시보드에서 즉각 제공합니다.
<br>
<img src="./source/메인1.png" width="100%" alt="AI 환경 비서">

**11) 글로벌 환경 뉴스 수집 및 AI 요약 번역**
- NYT 등 해외 유력 언론사의 환경 섹션 기사를 실시간 수집하고, AI를 통해 빠르고 정확하게 **한글로 번역 및 핵심 요약**하여 제공합니다.
<br>
<img src="./source/메인2.png" width="100%" alt="글로벌 환경 뉴스 AI 가공">
