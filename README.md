...
<br>
<img src="./source/채팅-프로필,채팅리스트.png" width="100%" alt="채팅방 목록 및 초대 관리">

**3) 유연한 1:1 및 그룹 채팅 생성**
- 주변 이웃과의 1:1 대화는 물론, 특정 주제나 목적에 맞는 **그룹 채팅방을 자유롭게 개설**할 수 있는 프로세스를 구축했습니다.
<br>
<div align="center">
...
<br>
<img src="./source/유저 클릭시 온라인확인,1대1신청기능.png" width="100%" alt="유저 온라인 상태 및 소통">

**5) 체계적인 방장 권한 및 멤버 관리**
- 채팅방 개설자(방장)는 멤버 초대, 방장 권한 위임, 부적절한 멤버 강제 퇴출 등 **강력한 방 관리 기능**을 수행하며, 일반 멤버와는 차별화된 관리 도구를 가집니다.
<br>
<div align="center">
...
<br>
<img src="./source/채팅방관리2.png" width="100%" alt="채팅방 설정 최적화">
...
- 사진과 파일을 자유롭게 업로드하고 썸네일로 즉시 확인하며, 수많은 대화 속에서 필요한 정보를 빠르게 찾을 수 있는 **전문화된 검색 기능**을 제공합니다.
<br>
<div align="center">
  <img src="./source/사진썸네일이나 파일 업로드, 마지막읽음 표시.png" width="60%" alt="미디어 공유 기능">
  <img src="./source/검색기능.png" width="38%" alt="메시지 검색 시스템">
</div>

**9) 맞춤형 날씨 정보 및 AI 환경 비서**
